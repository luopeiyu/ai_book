...
class HairClassifierNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            nn.Conv2d(1, 8, kernel_size=3, padding=1),  # 输入1通道（灰度图），输出8通道
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2),
            nn.Dropout2d(0.25),  # 添加Dropout防止过拟合
...
class HairClassifierTrainer:
    ...
    def __init__(self, data_folder, model_save_path='models/hair_classifier.pth'):
...
def main():
    ...
    model_save_path = "models/hair_classifier.pth"
    ...
    print("\n=== 测试预测器 ===")
    predictor = HairClassifierPredictor(model_save_path)
    
    # 测试预测
    test_image = "E:/B9/face/style_dataset/filtered_faces/test/realface (196).jpg"
