...
class LevelGenerationTrainer:
    ...
    def train(self, total_timesteps=1500000, moves_range=None, score_range=None):
        ...
        model.learn(
            ...
            tb_log_name="level_ppo_11"
        )
        
        model.save("models/level_generator_11")

class LevelGenerator:
    def __init__(self, model_path="models/level_generator_11"):
...
if __name__ == "__main__":    
    ...
    #evaluator = LevelEvaluator("models/level_generator_11")
    #print(evaluator.evaluate(moves_range, score_range))
    
    generator = LevelGenerator("models/level_generator_11")
