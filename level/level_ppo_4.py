...
class LevelGenerationTrainer:
    ...
    def train(self, total_timesteps=1500000, moves_range=None, score_range=None):
        ...
        model = PPO(
            ...
            gae_lambda=0.95,
            clip_range=0.2,
            ent_coef= 0,  #此前是0.005, 改为默认值0
            tensorboard_log="./logs/"
        )
            
        model.learn(
            total_timesteps=total_timesteps,
            tb_log_name="level_ppo_4"
        )
        
        model.save("models/level_generator_4")

class LevelGenerator:
    def __init__(self, model_path="models/level_generator_4"):
...
if __name__ == "__main__":    
    ...
    generator = LevelGenerator("models/level_generator_4")
