#在8的基础上，使用更大的模型参数
#实验12-1和12-2，都是如下结构，只是时间步不同，效果不好
#             policy_kwargs=dict(
...
class LevelGenerationTrainer:
    ...
    def train(self, total_timesteps=1500000, moves_range=None, score_range=None):
        ...
        model.learn(
            ...
            tb_log_name="level_ppo_12"
        )
        
        model.save("models/level_generator_12")

class LevelGenerator:
    def __init__(self, model_path="models/level_generator_12"):
...
if __name__ == "__main__":    
    ...
    trainer.train(total_timesteps=5000000, moves_range=moves_range, score_range=score_range)
    # 第一次实验1500000步，第二次干到5000000
    
    #evaluator = LevelEvaluator("models/level_generator_12")
    #print(evaluator.evaluate(moves_range, score_range))
    
    generator = LevelGenerator("models/level_generator_12")
