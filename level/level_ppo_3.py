...
class LevelGenerationTrainer:
    ...
    def train(self, total_timesteps=1500000, moves_range=None, score_range=None):
        ...
        model = PPO(
            ...
            batch_size=256,
            n_epochs=10,
            gamma=0.99,  #0.99是默认值，对比之前的0.999
            gae_lambda=0.95,
            clip_range=0.2,
            ent_coef=0.005,  # 鼓励探索
        ...
        model.learn(
            ...
            tb_log_name="level_ppo_3"
        )
        
        model.save("models/level_generator_3")

class LevelGenerator:
    def __init__(self, model_path="models/level_generator_3"):
...
if __name__ == "__main__":    
    ...
    trainer.train(total_timesteps=1500000, moves_range=[3], score_range=[1500])
    
    generator = LevelGenerator("models/level_generator_3")
    
    test_targets = [(3, 1500), (3, 1500), (3, 1500)]
