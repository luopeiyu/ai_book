...
class LevelGenerationTrainer:
    ...
    def train(self, total_timesteps=1500000, moves_range=None, score_range=None):
        ...
        model.learn(
            ...
            tb_log_name="level_ppo_7"
        )
        
        model.save("models/level_generator_7")

class LevelGenerator:
    def __init__(self, model_path="models/level_generator_7"):
...
if __name__ == "__main__":    
    ...
    trainer.train(total_timesteps=1500000, moves_range=[6], score_range=[3200])
    
    generator = LevelGenerator("models/level_generator_7")
    
    test_targets = [(6, 3200), (6, 3200), (6, 3200)]
