...
class LevelGenerationTrainer:
    ...
    def train(self, total_timesteps=1500000, moves_range=None, score_range=None):
        ...
        model.learn(
            ...
            tb_log_name="level_ppo_1"
        )
        
        model.save("models/level_generator_1")

class LevelGenerator:
    def __init__(self, model_path="models/level_generator_1"):
...
if __name__ == "__main__":    
    ...
    generator = LevelGenerator("models/level_generator_1")
